 ...
 * @modificationHistory.  
 * <ul>
 * <li>kjl 2010-8-24下午11:06:39 TODO</li>
 * </ul>
 */
...
public class MD5 {
	 ...
	 * @author kjl
	 * @creationDate. 2010-8-16 下午06:15:05 
	 * @param inbuf 想要进行MD5转换的字符串
	 * @return 变换完的结果(从公共成员digestHexStr取得的)
	 */
	 ...
	 * 初始化核心变量，装入标准的幻数
	 * @author kjl
	 * @creationDate. 2010-8-16 下午06:16:27 
	 */
	...
	public static void main(String args[]) {
		System.out.println(URLEncoder.encode(convertMD5("goodsId=1024&randomCode=437286fdsh473824937438")));
		System.out.println(convertMD5("goodsId=1024&randomCode=437286fdsh473824937438"));
		System.out.println(convertMD5(convertMD5("goodsId=1024&randomCode=437286fdsh473824937438")));
